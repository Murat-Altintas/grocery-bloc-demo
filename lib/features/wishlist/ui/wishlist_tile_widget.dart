      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(image: DecorationImage(fit: BoxFit.cover, image: NetworkImage(productDataModel.imageUrl))),
          ),
            ...
            children: [
              ...
              Row(
                children: [
                  IconButton(
                      onPressed: () {
                        wishlistBloc.add(ItemRemoveFromWishlistEvent(productDataModel: productDataModel));
                      },
